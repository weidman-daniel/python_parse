...
def log_parse(logString):
    port=re.findall(r'([Pp]ort:? |service:)"?([0-9]{1,5})"?', logString)
    return port

log="""<86>May 28 08:21:45 okcjumperp01 sshd[7824]: Failed password for invalid user faketst from 10.1.1.150 port 11332 ssh2
